...
function Game() {
    ...
    this.numberClicked= function(num){
        ...
        if( this.playerScore >= this.gameLen || this.compScore >= this.gameLen ){ return } //<-- stop user from moving after end of game
        ...
        document.getElementById("button"+(1-num)).style.borderColor = "red";
        setTimeout(function() {
        document.getElementById("button"+(1-num)).style.borderColor = "black";
      }, 125);
